    ...
    return (
      <main className='mainContainer'>
        <header id="home" ref={homeRef} className='mainContainer__banner'>
          ...
          <p className='mainContainer__banner--subtitle'>{displayedText}</p>
          <i className="fa-solid fa-code mainContainer__banner--icon"></i>
        </header>
        <section id="abilities" ref={abilitiesRef} className='mainContainer__skills'>
          ...
          <p ref={graduateInfoRef} className={`mainContainer__skills--graduateInfo ${inView ? 'animate' : ''}`}>Diplômée de la formation développeur web d'OpenClassrooms</p>
        </section>
        <section id="projects" ref={projectsRef} className='mainContainer__projects'>
        ...
        <section id="contact" ref={contactRef} className='mainContainer__contact'>
